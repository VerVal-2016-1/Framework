...
require_once dirname(__FILE__).'/../metadata/CreateIntegrationMetadata.php';
...
class CreateIntegrationCommand extends Command{
    ...
    const TESTS_PATH = "../integration_tests/";
    ...
    protected function set_metadata(){
        $this->metadata = new CreateIntegrationMetadata();
    }
    ...
    public function execute(){  
        ...
        if ($has_class_name){
            ...
            if(!empty($class_file)){
                ...
                $dir_exists = file_exists(self::TESTS_PATH);

                if(!$dir_exists){
                    mkdir(self::TESTS_PATH, 0755, TRUE);
                }

                $file_name = self::TESTS_PATH.$class_test_name.".php";
                ...
                throw new MetadataException("CONTROLLER_CLASS_NOT_FOUND");
            }
        }
    }
    ...
    private function create_file($file_name, $class_test_name){
        ...
        $content .= "require_once 'IntegrationTestCase.php';\n";
        
        $content .= "\nclass ".$class_test_name." extends IntegrationTestCase {\n\n";
    ...
    private function search_class_file($class_name){
        ...
        foreach (new RecursiveIteratorIterator($it) as $file) {
            ...
            if($file_name == strtolower($class_name).".php"){
